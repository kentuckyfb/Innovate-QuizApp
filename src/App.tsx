  ...
  return (
    <>
      ...
      >
        ...
        {/* Header with Logo and Title - Improved responsive classes */}
        <header className="w-full flex-shrink-0 flex flex-col items-center justify-center px-4 relative z-20 mt-8 sm:mt-10 md:mt-12">
          ...
          {/* Title with selective Jockey One font - Improved responsive text sizes */}
          <motion.div
            initial={{ opacity: 0, y: -20 }}
            animate={{ opacity: 1, y: 0 }}
            className="relative"
        ...
        {/* Main Content - Improved padding for better space utilization */}
