...
// Updated personality types from your quiz
const personalityDetails = {
  timekeeper: {
    ...
    traits: [
      'Precisely timing Avurudu rituals',
      'Calm and collected approach',
      'Respects traditional timing',
      'Ensures every moment is just right',
    ],
    icon: Clock,
    imagePath: image3,
    color: 'purple-800',
  ...
  creativeSparkle: {
    ...
    traits: [
      'Eye for stunning decorations',
      'Transforms spaces into magic',
      'Creates Instagram-worthy moments',
      'Artistic vision for celebrations',
    ],
    icon: Palette,
    imagePath: image2,
    color: 'purple-700',
  ...
  gamemaster: {
    ...
    traits: [
      'Organizes epic game competitions',
      'Knows all traditional games',
      'Ensures maximum participation',
      'Brings competitive energy',
    ],
    icon: Target,
    imagePath: image4,
    color: 'purple-700',
  ...
  harmonyKeeper: {
    ...
    traits: [
      ...
      'Keeps things smooth and easy',
      'Brings a calm presence',
    ],
    icon: Sparkles,
    imagePath: image3,
    color: 'purple-900',
  ...
  familyConnector: {
    ...
    traits: [
      ...
      'Natural at bringing people together',
      'Spreads love and positive vibes',
      'Makes family connections meaningful',
    ],
    icon: Heart,
    imagePath: image4,
    color: 'purple-600',
  ...
  celebrationFirecracker: {
    ...
    traits: [
      'Brings incredible energy',
      'Keeps celebrations exciting',
      'Spreads infectious joy',
  ...
  knowledgeKeeper: {
    ...
    traits: [
      ...
      'Always ready with information',
      'Preserves traditional wisdom',
        ...
        >
          ...
          <div className="mb-3 flex justify-center flex-shrink-0">
            <motion.img
              ...
              className="w-24 h-24 sm:w-32 sm:h-32 object-cover rounded-full border-4 shadow-lg"
              style={{ borderColor: theme.colors.secondary.main }}
            />
          </div>
